...
namespace ILAK.API
{
    ...
    public class ListOfIntfGenOption
    {
        public List<IntfGenOptions> Interfaces { get; set; }
    }
    ...
    public class IntfGenOptions
    {
        ...
        public ConnStrOption ConnOption { get; set; }

        public List<MethodOptions> Methods { get; set; }
    }

    public class ListOfMethodOption
    {
        public List<MethodOptions> Methods { get; set; }
    }
    ...
    public class ListAGGroupOptions
    {
        public List<AGGroupOption> listAGOptions { get; set; }
    }
