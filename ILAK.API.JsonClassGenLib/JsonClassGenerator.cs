...
namespace ILAK.API.JsonClassGenerator
{
    public class JsonClassGenerator : IJsonClassGeneratorConfig
    {
        ...
        public void GenerateClasses()
        {
            ...
            using (var reader = new JsonTextReader(sr))
            {
                ...
                {
                    throw new Exception("格式错误,应该是一个 JSON array, 或 JSON object.");
                }
            }
            ...
            if (writeToDisk)
            {
                ...
                //        JsonClassGeneratorLib.Properties.Resources.JsonClassHelper);
                //}
